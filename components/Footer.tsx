...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/in/muhammad-u-410933251',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-white font-display font-bold text-lg">
                UH
              </div>
              <span className="font-display font-bold text-lg">Usama Hafeez</span>
            </Link>
            <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed mb-4">
              Senior Software Engineer passionate about building scalable applications and sharing knowledge with the developer community.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2.5 rounded-lg bg-[var(--color-bg)] border border-[var(--color-border)] text-[var(--color-text-secondary)] hover:text-primary-500 hover:border-primary-500/50 transition-colors"
