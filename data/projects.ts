...
export const projects: Project[] = [
  {
    ...
    description: 'A full-featured e-commerce platform with real-time inventory management, payment processing, and analytics dashboard. Built for scale with microservices architecture.',
  ...
  },
  {
    ...
    description: 'Real-time monitoring and deployment dashboard for cloud infrastructure. Features CI/CD pipeline visualization, container orchestration, and alerting system.',
    ...
    liveUrl: 'https://devops-demo.johndoe.dev',
  },
  {
  ...
  },
  {
    ...
    description: 'A Notion-like collaborative workspace with real-time editing, rich text formatting, and team management features.',
    ...
    liveUrl: 'https://collab-demo.johndoe.dev',
  },
  {
    title: 'Fitness Tracking App',
    description: 'A comprehensive fitness tracking application with workout planning, progress visualization, and social features for accountability.',
  ...
  },
  {
    ...
    description: 'Enterprise-grade financial analytics platform with real-time market data, portfolio tracking, and automated reporting.',
    image: '/images/projects/finance.svg',
    techStack: ['Vue.js', 'Python', 'PostgreSQL', 'Apache Kafka', 'D3.js'],
    githubUrl: 'https://github.com/johndoe/finance-analytics',
  },
];
