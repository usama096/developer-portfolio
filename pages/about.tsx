          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-[var(--color-text-secondary)] leading-relaxed">
                <p>
                  Hi! I&apos;m John, a Senior Software Engineer based in San Francisco with a
                  passion for building products that make a real difference. With over 5 years of
                  experience in the tech industry, I&apos;ve had the privilege of working with
                  startups and enterprises alike.
                </p>
                <p>
                  My journey in software development started during my time at UC Berkeley, where I
                  discovered the joy of turning ideas into working applications. Since then,
                  I&apos;ve been on a continuous learning path, always exploring new technologies
                  and methodologies.
                </p>
                <p>
                  When I&apos;m not coding, you&apos;ll find me hiking in the Bay Area trails,
                  experimenting with new coffee brewing methods, or contributing to open-source
                  projects. I believe in giving back to the community that has given me so much.
                </p>
              </div>

              {/* Download Resume */}
              <div className="mt-8">
                <a href="/Usama_Software_Engineer_Resume.pdf" className="btn-primary" download>
                  <svg
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="card p-6">
                  ...
                  <p className="text-[var(--color-text-secondary)] font-medium mb-3">
                    {exp.company}
                  </p>
