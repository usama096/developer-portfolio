        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
              Sharing what I learn along the way. From technical deep-dives to thoughts on 
          ...
          {posts.length > 0 ? (
            ...
            >
              <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-[var(--color-bg-secondary)] flex items-center justify-center">
                <svg className="w-12 h-12 text-[var(--color-text-secondary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                </svg>
              </div>
              <h2 className="heading-md mb-4">No Posts Yet</h2>
              <p className="text-[var(--color-text-secondary)] max-w-md mx-auto">
                I&apos;m working on some great content. Check back soon for articles about 
                software development, tutorials, and more!
              </p>
            </motion.div>
          )}
        </div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-[var(--color-text-secondary)] mb-8">
              Get notified when I publish new articles. No spam, just quality content about 
